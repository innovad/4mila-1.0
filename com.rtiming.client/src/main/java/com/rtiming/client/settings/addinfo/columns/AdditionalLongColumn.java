...
public class AdditionalLongColumn extends AbstractLongColumn implements IAdditionalColumn {

  private final Long additionalInformationUid;
  private final String id;
  private final String text;

  public AdditionalLongColumn(Long additionalInformationUid, String id, String text) {
    super();
