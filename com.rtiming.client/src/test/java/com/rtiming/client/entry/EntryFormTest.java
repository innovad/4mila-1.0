...
public class EntryFormTest {
  ...
  public void before() throws ProcessingException {
    ...
    Mockito.when(batchLookupService.getBatchDataByKey(Mockito.any(BatchLookupCall.class))).thenReturn(lookupRows);
    runnerLookupService = Mockito.mock(IRunnerLookupService.class);
    Mockito.when(runnerLookupService.getDataByKey(Mockito.any(LookupCall.class))).thenReturn(row);
    clazzLookupService = Mockito.mock(IClazzLookupService.class);
    Mockito.when(clazzLookupService.getDataByKey(Mockito.any(LookupCall.class))).thenReturn(row);
    ecardLookupService = Mockito.mock(IECardLookupService.class);
    Mockito.when(ecardLookupService.getDataByKey(Mockito.any(LookupCall.class))).thenReturn(row);
    registrationLookupService = Mockito.mock(IRegistrationLookupService.class);
    Mockito.when(registrationLookupService.getDataByKey(Mockito.any(LookupCall.class))).thenReturn(row);
    clubLookupService = Mockito.mock(IClubLookupService.class);
    Mockito.when(clubLookupService.getDataByKey(Mockito.any(LookupCall.class))).thenReturn(row);
    cityLookupService = Mockito.mock(ICityLookupService.class);
    Mockito.when(cityLookupService.getDataByKey(Mockito.any(LookupCall.class))).thenReturn(row);
    eventLookupService = Mockito.mock(IEventLookupService.class);
    Mockito.when(eventLookupService.getDataByKey(Mockito.any(LookupCall.class))).thenReturn(row);
