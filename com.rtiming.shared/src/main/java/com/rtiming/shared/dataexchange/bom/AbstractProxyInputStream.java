package com.rtiming.shared.dataexchange.bom;
 ...
 */
public abstract class AbstractProxyInputStream extends FilterInputStream {
   ...
   */
  public AbstractProxyInputStream(InputStream proxy) {
    super(proxy);
   ...
   * of bytes that the caller wanted to read (1 for the {@link #read()} method, buffer length for {@link #read(byte[])},
   * etc.) is given as
   * an argument.
   * <p>
